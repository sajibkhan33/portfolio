          ...
          >
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <motion.li
                ...
                key={index}
                className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-purple-50 hover:-translate-y-1 duration-500 hover:shadow-[4px_4px_0_#000] dark:border-white dark:hover:shadow-white dark:hover:bg-black/50"
              >
                <Image
