...
const Contact = ({ isDarkMode }) => {
  ...
  return (
    ...
    >
      ...
      >
        I'd love to hear from you! If you have any questins,comments, or
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2  gap-6 mt-10 mb-8">
          <motion.input
            ...
            required
            className="flex-1 p-3  outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:bg-black/30 dark:border/90"
          />
          <motion.input
            initial={{ x: 50, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
